...
const Button = ({ text, icon, iconPosition = "left", onClick, className, to, width }) => {
  ...
  const buttonClasses = `flex items-center justify-center gap-2 px-4 py-2 text-sm rounded-lg text-white bg-purple-500 hover:bg-purple-600 transition-all duration-150 ${className} ${width ? width : 'w-auto'}`;
