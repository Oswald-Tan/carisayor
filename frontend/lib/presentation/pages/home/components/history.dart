...
Widget buildShimmerEffect() {
  return Container(
    ...
    decoration: BoxDecoration(
      color: Colors.white,
      borderRadius:
          BorderRadius.circular(10), // Border radius utama pada container utama
    ),
    child: ClipRRect(
      borderRadius:
          BorderRadius.circular(10), // Border radius pada shimmer content
            ...
            Row(
              children: [
                Padding(
                  ...
                  child: ClipRRect(
                    borderRadius:
                        BorderRadius.circular(15), // Border radius pada icon
                    child: Container(
                      width: 30,
                      height: 30,
                  ...
                  children: [
                    ClipRRect(
                      borderRadius: BorderRadius.circular(
                          10), // Border radius pada text container
                      child: Container(
                        width: 100,
                        height: 14,
                        color: Colors.white, // Warna placeholder
