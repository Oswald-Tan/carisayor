...
import 'package:frontend/presentation/pages/produk/components/pesanan_selection_cart.dart';
...
class CartScreenState extends State<CartScreen> {
  ...
  void _deleteCartItems(List<String> cartIds) async {
    try {
      ...
      // Jalankan semua operasi penghapusan secara bersamaan
      await Future.wait(
      ...
      // Refresh data keranjang setelah semua item dihapus
