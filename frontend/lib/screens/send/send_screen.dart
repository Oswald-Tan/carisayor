...
import 'package:frontend/screens/send/components/info_send.dart';
                ...
                ElevatedButton(
                  onPressed: () async {
                    if (phoneNumberPenerima.isNotEmpty) {
                      ...
                      if (konfirmasi) {
                        await (phoneNumberPenerima, jumlahCSPoin);
                      } else {
                        print('Pengguna membatalkan pengiriman poin');
                      }
                    } else {
                      print('Nomor penerima tidak boleh kosong');
                    }
                  },
